...
public:
     ...
     */
    Detector_PFLD(const std::string& model_path, const torch::DeviceType& device_type);
...
private:
     ...
     */
    static std::vector<cv::Point> PostProcessing(const torch::Tensor& detections, float conf_thres = 0.4, float iou_thres = 0.6);
